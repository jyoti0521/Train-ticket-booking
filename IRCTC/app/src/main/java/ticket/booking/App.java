...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while(option!=7){
            ...
            //Train trainSelectedForBooking = new Train();                   //sir ka h
...
//                    String dest = scanner.next().trim().toLowerCase();
...
//                            System.out.println((i + 1) + ". Train Name: " + t.getTrainNo() + ", Train ID: " + t.getTrainId());
//                            for (Map.Entry<String, String> entry : t.getStationTimes().entrySet()) {
//                                System.out.println("    - " + entry.getKey() + " at " + entry.getValue());
//                            }
//                        }
//                        System.out.println("Select a train by typing its number (1 to " + trains.size() + "):");
...
//                    break;
                ...
                case 4:
                    ...
                    trainSelectedForBooking = trains.get(selectedTrainIndex - 1); // fix index
                    break;
